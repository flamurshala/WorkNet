      ...
      <section class="account-option">
        <div class="container">
          <div class="inner-box">
            ...
            <a href="sign-in.php" class="btn-style-1"><i class="fa fa-sign-in"></i>Kyçu tani!</a>
          </div>
        </div>
      </section>
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6">
                <label>Emri i plotë</span></label>
                <input type="text" name="fullname" required autocomplete="off" />
              </div>

              <div class="col-md-6 col-sm-6">
                <label>Email</span></label>
                <input type="email" name="emailid" id="emailid" onBlur="useremailAvailability()" autocomplete="off"
                  required>
                <span id="user-emailavailability-status" style="font-size:12px;"></span>
              </div>

              <div class="col-md-6 col-sm-6">
                <label>Numri Telefonit</span></label>
                <input type="text" name="contactnumber" id="contactnumber" onBlur="usercontactnoAvailability()"
                  autocomplete="off" pattern="[0-9]+" title="only numeric digit allowed" maxlength="11" required>
                <span id="user-availability-status1" style="font-size:12px;"></span>
              </div>

              <div class="col-md-6 col-sm-6">
                <label>Fjalëkalimi</span></label>
                <input type="password" name="jspassword" autocomplete="off"
                  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"
              ...
              <div class="col-md-6 col-sm-12">
                <label>CV</span> <span style="font-size:12px;">(Vetëm pdf dhe doc pranohen)</span></label>
