...
<head>
  <meta charset="utf-8">
  <title>WorkNet || faqja kryesore</title>
...
<body class="theme-style-1">
  <div id="wrapper">
    ...
    <div class="banner-outer">
      ...
      <div class="caption">
        <div class="holder">
          <h1>Kërko punë online!</h1>
          <form action="job-search.php" method="post">
            <div class="container">
              <div class="row">
                <div class="col-md-5 col-sm-5">
                  <input type="text" placeholder="Emri i punës" name="jobtitle" required>
                </div>
                <div class="col-md-5 col-sm-5">
                  <input type="text" placeholder="Emri kompanisë" name="company">
                </div>
            ...
            foreach ($results as $row) { ?>
              <div class="col-md-3 col-sm-6">
                <div class="box" style=" border-radius: 10px;">
                  <h4><a href="view-categorywise-job.php?viewid=<?php echo htmlentities($row->jobCategory); ?>">
                      <?php echo htmlentities($row->jobCategory); ?>
                    </a></h4>
                  <strong>
                    <?php echo htmlentities($row->totaljobs); ?>
                  </strong>
                </div>
              </div>
            <?php } ?>
            ...
            <div class="col-md-12 col-sm-8">
              <div id="content-area">
                ...
                <ul id="myList">
                  ...
                  // Formula for pagination sourced 
                  ...
                  if ($query->rowCount() > 0) {
                    foreach ($results as $row) { ?>
                      <li>
                        <div class="box">
                          <div class="thumb"><a href="jobs-details.php?jid=<?php echo ($row->jobId); ?>"><img
                                src="employers/employerslogo/<?php echo $row->CompnayLogo; ?>" width="100" height="100"></a>
                          </div>
                          <div class="text-col">
                            <h4><a href="jobs-details.php?jid=<?php echo ($row->jobId); ?>">
                                <?php echo htmlentities($row->jobTitle); ?>
                              </a></h4>
                            <p>
                              <?php echo htmlentities($row->CompnayName); ?>
                            </p>
                            <a href="jobs-details.php?jid=<?php echo ($row->jobId); ?>" class="text"><i
                                class="fa fa-map-marker"></i>
                              <?php echo htmlentities($row->jobLocation); ?>
                            </a>
                            <a href="#" class="text"><i class="fa fa-calendar"></i>
