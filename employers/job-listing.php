...
if (strlen($_SESSION['emplogin']) == 0) {
  ...
  <head>
    ...
    <title>Punëdhënësi | Listimi i punëve</title>
  ...
  <body class="theme-style-1">
    <div id="wrapper">
      ...
      <section id="inner-banner">
        <div class="container">
          <h1>Punëdhënësi | Listimi i punëve</h1>
        </div>
      </section>
      <div id="main">
                ...
                <div id="content-area">
                  ...
                  <ul id="myList">
                    ...
                    if ($query->rowCount() > 0) {
                      ...
                      <h3 align="center" style="color:red;">Nuk është listuar asnjë punë</h3>
                    <?php } ?>
                  </ul>
                  <div align="left">
                    <ul class="pagination">
