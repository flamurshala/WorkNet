...
if (strlen($_SESSION['emplogin']) == 0) {
  ...
  <head>
    ...
    <title>Punëdhënësi | Publikimi i punës</title>
  ...
  <body class="theme-style-1">
    <div id="wrapper">
      ...
      <section id="inner-banner">
        <div class="container">
          <h1>Punëdhënësi | Publikimi i punës</h1>
        </div>
      </section>
      <div id="main">
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                  ...
                  <input type="text" name="jobtitle" required autocomplete="off">
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 col-sm-6">
                ...
                <div class="col-md-6 col-sm-6">
                  <label>Pagesa</label>
                  <input type="text" name="salarypackage" required>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 col-sm-6">
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                  ...
                  <input type="date" name="jed" required class="form-control">
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
              ...
              <div class="col-md-12">
                <div class="btn-col">
                  <input type="submit" name="submit" value="Publiko">
                </div>
              </div>
            </div>
      </div>
