...
if (strlen($_SESSION['emplogin']) == 0) {
  ...
  <head>
    ...
    <title>WorkNet-Profili kandidatit</title>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-8">
                <div class="resumes-content">
                  <h2>Showing CV of Hired Candidates</h2>
                  <h2>Cv-të e kandidatëve të punësuar</h2>
                  <div class="box">
                    <?php
                    ...
                    if ($query->rowCount() > 0) {
                      ...
                      <h3 align="center" style="color:red;">Nuk u gjetë asnjë kandidat</h3>
                    <?php } ?>
                  </div>
                  <div align="left">
                    <ul class="pagination">
