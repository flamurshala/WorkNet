...
if (strlen($_SESSION['emplogin']) == 0) {
  ...
  <head>
    ...
    <title>WorkNet-Candidates Profiles</title>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-8">
                <div class="resumes-content">
                  <h2 style="color: blue">Rezultatet e kërkimit
                    ...
                    if ($query->rowCount() > 0) {
                      foreach ($results as $row) { ?>
                        ...
                        <div class="text-box">
                          ...
                          <div class="btn-row">
                            <a href="../Jobseekersresumes/<?php echo htmlentities($row->Resume); ?>" class="resume"
                              target="_blank"><i class="fa fa-file-text-o"></i>CV</a>
                            <a href="candidates-details.php?canid=<?php echo ($row->id); ?>" class="contact"
                              target="_blank">Detajet e kandidatit</a> <a
                              href="app-details.php?jobid=<?php echo ($row->JobId); ?> && name=<?php echo htmlentities($row->FullName); ?>"
                      ...
                      <h4 align="center" style="color:blue">Nuk u gjetë asgjë</h4>
                    <?php } ?>
                  </div>
                  <div align="left">
                    <ul class="pagination">
