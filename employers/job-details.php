...
if (strlen($_SESSION['emplogin']) == 0) {
  ...
  <head>
    <title>Detajet e punës | Punëdhënësit</title>
                  ...
                  if ($query->rowCount() > 0) {
                    foreach ($results as $result) {
                      ...
                      <div class="box">
                        <div class="thumb">
                          <a href="#">
                            <img src="employerslogo/<?php echo htmlentities($result->CompnayLogo); ?>" alt="img" width="165"
                              height="165"></a>
                        </div>
                        <div class="text-col">
                          <h2>
                          ...
                          <p>Eksperienca e kërkuar :
                            <?php echo htmlentities($result->experience); ?>
                          </p>

                          <a class="text"><i class="fa fa-map-marker"></i>
                            <?php echo htmlentities($result->jobLocation); ?>
                          </a>
                          <a class="text"><i class="fa fa-calendar"></i>
                        ...
                        <div class="clearfix">
                          ...
                          <p>
                            <?php echo htmlentities($result->skillsRequired); ?>
                          </p>
                          <h4>Përshkrimi</h4>
                          <p>
